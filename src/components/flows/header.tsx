    ...
    <div className="flex flex-col gap-1.5 px-6 pt-5">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          ...
          title={t("flows_header.004")}
          aria-label={t("flows_header.004")}
        ...
        <input
          ...
          placeholder={t("flows_header.002")}
          spellCheck={false}
          aria-label={t("flows_header.002")}
        ...
        {dirty && (
          <span
            ...
            title={t("flows_header.005")}
            aria-live="polite"
          >
            <span className="h-1.5 w-1.5 rounded-full bg-amber-400" /><T k="flows_header.001" /></span>
        )}
        ...
        <div className="ml-auto flex flex-wrap items-center gap-1.5">
          ...
          >
            <History className="h-3.5 w-3.5" /><T k="dashboard_flows_id_runs_page.001" /><span className="ml-0.5 rounded bg-muted px-1.5 py-0.5 font-mono text-[11px] text-muted-foreground">
      ...
      <input
        ...
        placeholder={t("flows_header.003")}
        aria-label={t("flows_header.006")}
